...
export default function ProgressCardRed() {
            ...
            <View style={styles.main}>
                ...
                <View style={styles.container}>
                    <View style={{ flexDirection: 'row' }}>
                        <Image
                            source={require('../assets/icons/comment-code.png')}
                        />
                        <View style={{width: 5}} />
                        <Text style={styles.courseName}>Front-End Development</Text>
                    </View>
                    <View style={{ height: 10 }} />
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={styles.courseCount}>Course 6/20</Text>
                        <Spacer />
